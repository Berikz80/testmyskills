...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val timerIsEnabled = findViewById<CheckBox>(R.id.timer)
        timerIsEnabled.setOnClickListener{ viewModel.isTimeEnabled = timerIsEnabled.isChecked && !viewModel.isTimeEnabled }
        ...
        startButton.setOnClickListener {
            ...
            intent.putExtra("timer", viewModel.isTimeEnabled )
